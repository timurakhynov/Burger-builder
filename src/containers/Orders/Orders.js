...
import { getOrderce } from '../../store/orders.slice';


const Orders = () => {
    const dispatch = useDispatch()
    const {orders, loading} = useSelector(state => state.orders, shallowEqual)  //shallowEqual -- следит только за нужнми переменными
